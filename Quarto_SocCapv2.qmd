...
states <- st_read("Shapefile_SocCap/gadm41_USA_shp/gadm41_USA_1.shp") %>% 
...
```{r}
tiff(filename = "./output/Figure 1.tif", units="in", width=8, height=8, res=300, bg = "white")
  margin_map
dev.off()
```
...
```{r}
tiff(filename = "./output/Figure 2.tif", units="in", width=10, height=8, res=300, bg = "white")
  p
dev.off()
```
...
map_civorg <- ggplot(data = counties) +
  ...
  scale_fill_viridis_c(name = "Public good Facebook pages per 1,000 users (log)", 
                       option = "C",
                       trans = "log",
  ...
  theme(title = element_text(size = 20, face = "bold", colour = "#000000"),
        ...
        legend.key.height = unit(0.4, "cm")) +
   geom_sf(data = states, color = "white", fill = "grey70", alpha = 0.2, linewidth = 0.3)

map_vol <- ggplot(data = counties) +
  geom_sf(aes(fill = volunteering_rate_county, geometry = geometry), color = "transparent", size = 0.5) +
  scale_fill_viridis_c(name = "Percent of Facebook users in volunteering or activism (log)", 
                       option = "C",
                       trans = "log",
                       labels = label_log(base = 10),
                       guide = guide_colorbar(title.position="top")) +
...
```{r}
tiff(filename = "./output/Figure 3.tif", units="in", width=8, height=8, res=300, bg = "white")
  map_civorg / map_vol
dev.off()
```
...
```{r}
tiff(filename = "./output/Figure 4.tif", units="in", width=8, height=8, res=300, bg = "white")
  map_sup / map_clu
dev.off()
```
...
```{r}
tiff(filename = "./output/Figure 5.tif", units="in", width=8, height=6, res=300, bg = "white")
  last_plot()
dev.off()
```
...
```{r}
tiff(filename = "./output/model-coef_social-capital_2016.tif", units="in", width=8, height=8, res=300, bg = "white")
  last_plot()
dev.off()
```
...
```{r}
tiff(filename = "./output/model-coef_social-capital_2020.tif", units="in", width=8, height=8, res=300, bg = "white")
  last_plot()
dev.off()
```
...
interact_plot(modelint16_1, 
              ...
              y.label = "Predicted Trump's Margin 2016",
              legend.main = "Organizations")

tiff(filename = "./output/Figure 7_1.tif", units="in", width=8, height=5, res=300, bg = "white")
  last_plot()
dev.off()
...
tiff(filename = "./output/Figure 7_2.tif", units="in", width=8, height=5, res=300, bg = "white")
  last_plot()
dev.off()
...
tiff(filename = "./output/Figure 7_3.tif", units="in", width=8, height=5, res=300, bg = "white")
  last_plot()
dev.off()
...
tiff(filename = "./output/Figure 7_4.tif", units="in", width=8, height=5, res=300, bg = "white")
  last_plot()
dev.off()
...
tiff(filename = "./output/Figure 7_5.tif", units="in", width=8, height=5, res=300, bg = "white")
  last_plot()
dev.off()
...
tiff(filename = "./output/Figure 7_6.tif", units="in", width=8, height=5, res=300, bg = "white")
  last_plot()
dev.off()
...
tiff(filename = "./output/Figure 7_7.tif", units="in", width=8, height=5, res=300, bg = "white")
  last_plot()
dev.off()
...
tiff(filename = "./output/Figure 7_8.tif", units="in", width=8, height=5, res=300, bg = "white")
  last_plot()
dev.off()
...
tiff(filename = "./output/Figure 7_9.tif", units="in", width=8, height=5, res=300, bg = "white")
  last_plot()
dev.off()
...
tiff(filename = "./output/Figure 7_10.tif", units="in", width=8, height=5, res=300, bg = "white")
  last_plot()
dev.off()
...
tiff(filename = "./output/Figure 8_1.tif", units="in", width=8, height=5, res=300, bg = "white")
  last_plot()
dev.off()
...
tiff(filename = "./output/Figure 8_2.tif", units="in", width=8, height=5, res=300, bg = "white")
  last_plot()
dev.off()
...
tiff(filename = "./output/Figure 8_3.tif", units="in", width=8, height=5, res=300, bg = "white")
  last_plot()
dev.off()
...
tiff(filename = "./output/Figure 8_4.tif", units="in", width=8, height=5, res=300, bg = "white")
  last_plot()
dev.off()
...
tiff(filename = "./output/Figure 8_5.tif", units="in", width=8, height=5, res=300, bg = "white")
  last_plot()
dev.off()
...
tiff(filename = "./output/Figure 8_6.tif", units="in", width=8, height=5, res=300, bg = "white")
  last_plot()
dev.off()
...
tiff(filename = "./output/Figure 8_7.tif", units="in", width=8, height=5, res=300, bg = "white")
  last_plot()
dev.off()
...
tiff(filename = "./output/Figure 8_8.tif", units="in", width=8, height=5, res=300, bg = "white")
  last_plot()
dev.off()
