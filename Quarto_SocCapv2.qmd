...
interact_plot(modelint16_3,
              ...
              data = data_trump2,
              interval = TRUE,
              main.title = "Job Earnings Growth x Clustering",
              x.label = "Job Earnings Growth",
              y.label = "Predicted Trump's Margin",
...
interact_plot(modelint16_4,
              ...
              data = data_trump2,
              interval = TRUE,
              main.title = "Job Earnings Growth x Support Networks",
              x.label = "Job Earnings Growth",
              y.label = "Predicted Trump's Margin",
              legend.main = "Support Networks")
...
interact_plot(modelint16_4,
              ...
              data = data_trump2,
              interval = TRUE,
              main.title = "Wage-Salary Growth x Support Networks",
              x.label = "Wage-Salary Growth",
              y.label = "Predicted Trump's Margin",
              legend.main = "Support Networks")
...
interact_plot(modelint16_5,
              ...
              data = data_trump2,
              interval = TRUE,
              main.title = "Wage-Salary Growth x Econ. Connect.",
              x.label = "Wage-Salary Growth",
              y.label = "Predicted Trump's Margin",
              legend.main = "Econ. Connect.")
...
interact_plot(modelint20_4,
              ...
              data = data_trump2,
              interval = TRUE,
              main.title = "Average Earnings Growth × Support Networks",
              x.label = "Average Earnings Growth (1980–2019)",
              y.label = "Predicted Trump's Margin (2020)",
              legend.main = "Support Networks")
...
interact_plot(modelint20_4,
              ...
              x.label = "Wages Growth (1980–2019)",
              y.label = "Predicted Trump's Margin (2020)",
              legend.main = "Support Networks")
